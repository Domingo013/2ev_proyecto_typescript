...
export class VistaListar extends Vista{
	...
	public btnListar: any;
	public divMotos: any;
	public bd: any;
	public divTarjeta: any;
	public divImagen: any;
	public imagen: any;
	public divBotones: any;
	public spanEditar: any;
	public iconoEditar: any;
	public spanBorrar: any;
	public iconoBorrar: any;
	public divTarjetaAnadir: any;
	public spanAnadir: any;
	...
	pulsarListar(){
		...
		solicitud.onsuccess = (evento:any) =>{
			...
			solicitud.onsuccess = (() =>{
				...
				this.divTarjetaAnadir.onclick = this.pulsarAnadir.bind(this)
